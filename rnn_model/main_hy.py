# command: python main_hy <model_name> <save_path>            model_name is one of {hybrid, rnn, tr}
import numpy as np
import shutil
import theano
...
if model_name == "hybrid":
    from model_hy import charLM
elif model_name == "rnn":
    from model_rnn import charLM
elif model_name == "tr":
    from model_tr import charLM
